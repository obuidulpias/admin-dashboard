            ...
            <div class="col-md-8 offset-md-2">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Add New Email Type</h3>
                    </div>
                    <form action="{{ route('email-types.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name"
                                    ...
                                    placeholder="Enter email type name" value="{{ old('name') }}" required>
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="constant"
                                    ...
                                    placeholder="e.g., WELCOME_EMAIL" value="{{ old('constant') }}" required>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Email Type
                            </button>
